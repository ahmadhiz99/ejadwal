...
export default function FormRoom({ auth }) {
    const data = usePage().props.data?.original.data;
    const [roomName, setRoomName] = useState(data ? data.room_name : "");
    const [description, setDescription] = useState(
        data ? data.description : ""
    );
    const handleSubmit = (e, id) => {
        e.preventDefault();
        router.visit(`/room-${data ? `update/${id}` : "store"}`, {
