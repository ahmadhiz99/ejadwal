...
export default function FormSubject({ auth }) {
    const data = usePage().props.data?.original.data;
    const [subjectName, setSubjectName] = useState(data ? data.subject_name : "");
    const [description, setDescription] = useState(
        data ? data.description : ""
    );
    const handleSubmit = (e, id) => {
        e.preventDefault();
        router.visit(`/subject-${data ? `update/${id}` : "store"}`, {
